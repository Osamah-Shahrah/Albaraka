...
if (chec_use_permission($page_id)) {
    ...
    if (isset($_GET['JJSNwewyhjnbgh'])) {
        $id_branch_select = decrypt_id($_GET['JJSNwewyhjnbgh']);
...
<?php
    content_header('إستلام الرسائل-سائقين')
    ?>
...
<div class="container-fluid" >
    ...
    <div class="card card-warning card-outline">
        ...
        <i class="far fa-building"></i>
            ألفروع وعدد الرسائل الموكلة لي
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="Driver_Receives_branch_table" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th># </th>
                            <th>من</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $stmt_bra_driv = mysqli_prepare($con, "SELECT  br1.id_branch,o.fk_id_branch_recipient,br1.name_branch 'br_sender' ,br2.name_branch 'br_recev',COUNT(DISTINCT o.id_order) AS 'number_mess'
                             ...
                             WHERE o.check_receipt_sender=1 AND o.status_order=1 AND o.fk_level_mess=2 AND o.check_export=0 AND o.`ch_ex_us_fri`=1 AND o.`user_id__export`!=0 AND o.fk_id_driver= ? 
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Edit data" class="btn btn-info btn-sm "
                                    href="kjhksje?JJSNwewyhjnbgh=<?php echo encrypt_id($array_branch['fk_id_branch_recipient']); ?>"
                                    role=" button">
                                    تحديد
    ...
    <div class="card card-warning card-outline">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="check_Driver_Receives_table" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>QR</th>
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql_quer_mess = "SELECT o.id_order,o.QR,j2.name_branch as 'name_des', COUNT(DISTINCT oi.id_item_order) AS 'number_item',`date_export`
                                 FROM `order` o JOIN `branch` j2 ON o.fk_id_branch_recipient=j2.id_branch JOIN order_item oi ON o.id_order=oi.fk_order
                                  WHERE `check_receipt_sender`=1 AND o.fk_level_mess=2  AND `status_order`=1 AND o.check_export=0  
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($array_mess['date_export']); ?></td>

                            <td>


                                        <button type="button" class="btn btn-block btn-outline-danger btn-sm" 
                                        id="reject_<?php echo  htmlspecialchars($array_mess['id_order']); ?>"  name="reject_the_mess" 
                            ...
                            <td>
                                        ...
                                        id="accept_<?php echo  htmlspecialchars($array_mess['id_order']); ?>"  name="accept_the_mess" 
